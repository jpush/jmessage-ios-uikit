...
- (void)setupGroupMemberGrip {
  ...
  [_groupMemberGrip registerNib:[UINib nibWithNibName:FrameworkNibResourceWithName(@"JMUIGroupMemberCollectionViewCell") bundle:nil]
     forCellWithReuseIdentifier:FrameworkNibResourceWithName(@"JMUIGroupMemberCollectionViewCell")];
  
  [_groupMemberGrip registerNib:[UINib nibWithNibName:FrameworkNibResourceWithName(@"JMUIFootTableCollectionReusableView") bundle:nil]
     forSupplementaryViewOfKind:UICollectionElementKindSectionFooter
            withReuseIdentifier:FrameworkNibResourceWithName(@"JMUIFootTableCollectionReusableView")];
