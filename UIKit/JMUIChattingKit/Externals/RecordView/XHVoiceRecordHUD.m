...
- (void)configRecordingHUDImageWithPeakPower:(CGFloat)peakPower {
  ...
  self.recordingHUDImageView.image = [UIImage jmui_imageInResource:imageName];
}
...
- (void)setup {
  ...
  if (!_microPhoneImageView) {
    ...
    microPhoneImageView.image = [UIImage jmui_imageInResource:@"RecordingBkg"];
  ...
  if (!_recordingHUDImageView) {
    ...
    recordHUDImageView.image = [UIImage jmui_imageInResource:@"RecordingSignal"];
  ...
  if (!_cancelRecordImageView) {
    ...
    cancelRecordImageView.image = [UIImage jmui_imageInResource:@"RecordCancel"];
