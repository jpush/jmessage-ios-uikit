...
@implementation JMUIMessageTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style
  ...
  if (self) {
    ...
    _messageContent = [JMUIMessageContentView new];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
  if (buttonIndex == 1) {
    ...
    if (_model.message.contentType == kJMSGContentTypeImage) {
      ...
      [[JMUISendMsgManager ins] addMessage:weakSelf.model.message withConversation:_conversation];
    } else {
