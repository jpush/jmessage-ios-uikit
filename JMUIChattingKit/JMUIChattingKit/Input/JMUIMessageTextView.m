...
- (void)setPlaceHolder:(NSString *)placeHolder {
  ...
  NSUInteger maxChars = [JMUIMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
  return [JMUIMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
  return (text.length / [JMUIMessageTextView maxCharactersPerLine]) + 1;
}
