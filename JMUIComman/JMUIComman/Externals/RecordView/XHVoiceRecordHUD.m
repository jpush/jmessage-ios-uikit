...
- (void)configRecordingHUDImageWithPeakPower:(CGFloat)peakPower {
  ...
  self.recordingHUDImageView.image = [UIImage xhrecord_imageInResource:imageName];
}
...
- (void)setup {
  ...
  if (!_microPhoneImageView) {
    ...
    microPhoneImageView.image = [UIImage xhrecord_imageInResource:@"RecordingBkg"];
  ...
  if (!_recordingHUDImageView) {
    ...
    recordHUDImageView.image = [UIImage xhrecord_imageInResource:@"RecordingSignal"];
  ...
  if (!_cancelRecordImageView) {
    ...
    cancelRecordImageView.image = [UIImage xhrecord_imageInResource:@"RecordCancel"];
