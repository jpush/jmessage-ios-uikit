...
- (void)setUpCollectionView {
  ...
  [photoGridView registerNib:[UINib nibWithNibName:@"JMUIThumbImageCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:@"JMUIThumbImageCollectionViewCell"];
...
//  }
  ...
  if ([_photoDelegate respondsToSelector:@selector(JMUIPhotoPickerViewController:selectedPhotoArray:)]){
    ...
    [_photoDelegate JMUIPhotoPickerViewController:self selectedPhotoArray:selectedImageArr];
  }
